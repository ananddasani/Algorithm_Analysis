...
//                long cost = insertionSort(arr);
                ...
                //sort the data using insertion sort algo and get the cost
                long cost = mergeSort(arr, 0, arr.length - 1);
    ...
    /**
     * The mergeSort method will divide array by half and at last merge them in sorted way
     *
     * @param arr  is the array to be sorted
     * @param low  is the lowest index of array
     * @param high is the high / last index of array
     */
    ...
    /**
     * The merge method will merge the two array in sorted manner
     *
     * @param arr  is the array to be sorted
     * @param low  is the lowest index of array
     * @param mid  is the middle index of array
     * @param high is the highest index of array
     */
...
ive the unsorted number list file
[ex. 1_Digit_100_entries.txt] :: 1_Digit_100_entries.txt

Enter file name you want to store sorted data
[ex. 1_Digit_100_sorted_entries.txt] :: 1_Digit_100_sorted_entries.txt
